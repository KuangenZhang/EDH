...
class Feature(nn.Module):
    def __init__(self, dataset='ENABL3S', sensor_num=0):
        ...
        self.conv1 = nn.Conv2d(1, 4, kernel_size=[1, 1], stride=[
                               1, 1], padding=[0, 0])
        self.bn1 = nn.BatchNorm2d(4)
        self.conv2 = nn.Conv2d(4, 16, kernel_size=[1, 1], stride=[
                               1, 1], padding=[0, 0])
        self.bn2 = nn.BatchNorm2d(16)
        self.conv3 = nn.Conv2d(16, 256, kernel_size=final_kernel_size, stride=[
                               1, 1], padding=[0, 0])
...
class DomainPredictor(nn.Module):
    def __init__(self, prob=0.5):
        ...
        self.bn_fc2 = nn.BatchNorm1d(class_num)
        self.prob = prob
